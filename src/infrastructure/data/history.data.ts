...
export const historyData: HistoryMilestone[] = [
  ...
  },
  {
    id: 'h3',
    stage: 'La siembra',
    title: 'Cada chapola, sembrada a mano',
    description:
      'Empacaron la tierra bolsa por bolsa y, con una estaca, trasplantaron cada chapola del semillero. Sembraron cerca de 800 matas y, en pleno verano, cargaron agua mata por mata para que no se secaran.',
  },
  {
    id: 'h4',
    stage: 'La sombra',
  ...
  {
    id: 'h5',
    stage: 'La primera cosecha',
    title: 'Cuatro años después, la primera taza',
    description:
      'Despulpaban el café con una máquina de moler maíz y a mano, hasta que vendieron una vaca para comprar una despulpadora propia. El secado se hacía sobre hojas de zinc.',
  },
  {
    id: 'h6',
    stage: 'Hoy',
